...
@section("description", "Hotel ubicado en Doradal Antioquia nuestra propuesta se basa en caracterizar nuestros estilos al mejor estilo del viejo oeste")
...
@stop
@section("content")
    <div id="modal" style="z-index:999;display:block;width:600px;height:300px;position:fixed;background:rgba(255,255,255,0.9);border-radius:10px;">
    ...
    <section class="viejooeste-service viejooeste-feature-container" id="viejooeste_service">
        <img src="img/services.jpg" alt="Servicios Hotel Viejo Oeste - Doradal Antioquia" title="Servicios Hotel Viejo Oeste - Doradal Antioquia" onload="ViejoOesteUtils.Global.setHeight('#viejooeste_service')"/>
    ...
    <section class="viejooeste-spaces viejooeste-feature-container" id="viejooeste_spaces">
       <img src="img/spaces.jpg" alt="Espacios Hotel Viejo Oeste - Doradal Antioquia" title="Espacios Hotel Viejo Oeste - Doradal Antioquia" onload="ViejoOesteUtils.Global.setHeight('#viejooeste_spaces')"/>
       <div class="feature imagen-block">
           <div class="block">
               <div class="vertical-align">
        ...
        <div class="feature text-block">
            <div class="block">
                <div class="vertical-align">
                    ...
                    <p>El Hotel Viejo Oeste caracteriza todos sus servicios bajo el enfoque del viejo oeste logrando convertirse en la mejor propuesta de todos los <strong>hoteles en Doradal</strong> Antioquia.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="viejooeste-spaces viejooeste-feature-container" id="viejooeste_spaces">
       <img src="img/hotelviejooeste.jpg" alt="Espacios Hotel Viejo Oeste - Doradal Antioquia" title="Espacios Hotel Viejo Oeste - Doradal Antioquia" onload="ViejoOesteUtils.Global.setHeight('#viejooeste_spaces')"/>
       <div class="feature imagen-block">
           <div class="block">
               <div class="vertical-align">
        ...
        <div class="feature text-block">
            <div class="block">
                <div class="vertical-align">
                    ...
                    <p>Estamos ubicados en una de las regiones de Antioquia con mayor crecimiento en turismo en los últimos años. Ven y conoce a Doradal de mano de nuestras ofertas y actividades</p>
                </div>
            </div>
        </div>
    </section>
    <section class="viejooeste-spaces viejooeste-feature-container" id="viejooeste_spaces">
       <img src="img/hotelviejooeste_pool.jpg" alt="Espacios Hotel Viejo Oeste - Doradal Antioquia" title="Espacios Hotel Viejo Oeste - Doradal Antioquia" onload="ViejoOesteUtils.Global.setHeight('#viejooeste_spaces')"/>
       <div class="feature imagen-block">
           <div class="block">
               <div class="vertical-align">
                   <h2>Te esperamos ...</h2>
